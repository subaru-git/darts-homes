...
const meta: Meta<typeof CardView> = { component: CardView, title: 'Containers/Respect/CardView' };
      ...
      companies: [
        {
          ...
          image:
            'https://www.dartslive.com/wp-content/themes/dartslive/images/apple-touch-icon.png',
          description:
