      ...
      <Flex justifyContent='space-between' alignItems='center'>
        <NewGame
          onNewGame={(targetRound) => {
            if (game.isFinished()) saveHistory(game.getGameResult(), db.shanghaiNightsResult, user);
            setGame(new ShanghaiNightsGame(targetRound));
          }}
...
const MyRoundScore: FC<MainProps> = ({ game, setGame, user }) => (
  <RoundScore
    ...
    isFinished={game.isFinished()}
    onRoundOver={() => {
      saveHistory(game.getGameResult(), db.shanghaiNightsResult, user);
      setGame(new ShanghaiNightsGame(game.getTargetRound()));
    }}
