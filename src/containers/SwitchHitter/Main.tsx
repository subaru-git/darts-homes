...
const Main: FC = () => {
  ...
  const t = useTranslations('games.switchhitter');
      ...
      <Flex justifyContent='space-between' alignItems='center'>
        <NewGame
          onNewGame={(targetRound) => {
            if (game.isFinished()) saveHistory(game.getGameResult(), db.switchHitterResult, user);
            setGame(new SwitchHitterGame(targetRound));
          }}
