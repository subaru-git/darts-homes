...
import { DoubleTroubleResultModel } from '@/db/db';
import { deleteDoubleTroubleHistory } from '@/lib/GameHistoryManager/GameHistory';

type DoubleTroubleHistoryTableProps = {
  history: DoubleTroubleResultModel[];
};

const DoubleTroubleHistoryTable: FC<DoubleTroubleHistoryTableProps> = ({ history }) => {
    ...
    <>
      ...
      {deleteHistory ? (
        <HistoryDeleteAlert
          ...
          onClose={onClose}
          onDelete={() => {
            deleteDoubleTroubleHistory(deleteHistory.id);
            onClose();
          }}
        />
      ) : null}
...
export default DoubleTroubleHistoryTable;
