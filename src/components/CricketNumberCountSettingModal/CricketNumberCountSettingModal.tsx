...
type CricketNumberCountSettingModalProps = {
  isOpen: boolean
  onClose: () => void
  targetCount: number
...
const CricketNumberCountSettingModal: FC<CricketNumberCountSettingModalProps> = ({
  isOpen,
  onClose,
  targetCount,
  onNewGame,
...
export default CricketNumberCountSettingModal
