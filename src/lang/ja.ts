const text = {
  home: {
    ...
    description: {
      title: ['家ダーツの練習を提案'],
      description: [
        'ついつい単調になりがちな家ダーツに練習方法を提案します。',
        '練習方法はYouTubeやBlogなどを参考にして、アプリとしてサポートしています。',
      ],
    },
    history: {
      title: ['あなたの成長を少しだけサポート'],
      description: [
        'あなたの練習結果を記録して、成長を見えるようにします。',
        '右上からログインすることでサーバへ保存され、端末間で同期されます。',
      ],
      disclaimer: [],
    },
    respect: {
      title: ['あらゆるダーツコンテンツに感謝'],
      description: [
        'このサイトは各ダーツメーカーをはじめ、',
        'プレイヤー、YouTube、ブログなどあらゆるコンテンツに感謝し、その全てを尊重します。',
      ],
    },
  },
  footer: {
  ...
  games: {
    ...
    cricketmarkup: {
      ...
      description: [
        ...
        '最初に目標の回数を設定します（推奨10回）。',
        '次に20から15、BULLまでのクリケットナンバーを目標の回数狙っていきます。',
        '詳しくは動画をご覧ください。',
      ],
    ...
    arrange: {
      ...
      help: [
        ...
        },
        {
          ...
          hint: {
            header: 'Fixed Score?',
            body: 'スコアが入力されていると、すべてのラウンドで入力されたスコアがターゲットになります。',
          },
        },
      ],
    },
