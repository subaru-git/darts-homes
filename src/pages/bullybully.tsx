...
const BullyBully: NextPage<Props> = ({ title, description, canonical }) => {
  return (
    <>
...
export const getStaticProps: GetStaticProps<Props> = async ({ locale }) => {
  ...
  const { title, description } = seo.bullybully;
  const canonical = `https://darts.homes${locale === 'en' ? '/en' : ''}/bullybully`;
